...
void init_label_print_progress()
{
    ...
    lv_style_set_text_color(&style_label_print_progress,lv_color_hex(0x0000FF));     //设置样式文本字颜色
...
void init_arc_print_progress()
{
    ...
    lv_obj_set_style_arc_color(arc_print_progress, lv_color_hex(0x0000FF), LV_PART_INDICATOR);//进度条颜色
...
void init_label_extruder_actual_temp()
{
    ...
    lv_style_set_text_color(&style_label_ext_actual_temp,lv_color_hex(0x0000FF));     //设置样式文本字颜色
...
void init_label_extruder_target_temp()
{
    ...
    lv_style_set_text_color(&style_label_ext_target_temp,lv_color_hex(0x0000FF));     //设置样式文本字颜色
...
void init_label_heaterbed_actual_temp()
{
    ...
    lv_style_set_text_color(&style_label_bed_actual_temp,lv_color_hex(0x0000FF));     //设置样式文本字颜色
...
void init_label_heaterbed_target_temp()
{
    ...
    lv_style_set_text_color(&style_label_bed_target_temp,lv_color_hex(0x0000FF));     //设置样式文本字颜色
